program main
  ...
  REAL(kind=dp) :: JVS(LU_NONZERO_12),JVS_orig(LU_NONZERO)
  REAL(kind=dp) :: X_selected(LU_NSEL_12),X_deleted(LU_NDEL_12),X(NVAR)
  REAL(kind=dp) :: JVS1(LU_NONZERO_12),JVS2(LU_NONZERO)
  REAL(kind=dp) :: F(NFIX),RCT(NREACT),Vdot_SEL(LU_NSEL_12),Vdot(NVAR),diff(LU_NSEL_12)
  REAL(kind=dp) :: diff2(LU_NONZERO_12)
  REAL(kind=dp) :: Jcb1(LU_NSEL_12,LU_NSEL_12),Jcb2(NVAR,NVAR),Jcb3(LU_NSEL_12,LU_NSEL_12)
  REAL(kind=dp) :: JacDiff(LU_NSEL_12,LU_NSEL_12)
  INTEGER:: IER,i,j,k
  ...
  CALL Jac_SP_12(X_selected,X_deleted, F, RCT, JVS1)
  DO i=1,LU_NONZERO_12
     Jcb1(LU_IROW_12(i),LU_ICOL_12(i)) = JVS1(i)
  END DO  
  ...
  DO i=1,LU_NSEL_12
    DO j=1,LU_NSEL_12
	  Jcb3(i,j)=Jcb2(select_ind_12(i),select_ind_12(j))
	END DO
  END DO
